...
class WPRMTest(CommonTestCases.APITestBase):
    def setUp(self):
        ...
        recipe = datamodel.Recipe(
            ...
            4,
            [
                Ingredient("Kartoffeln", 1, "kg", "festkochend"),
                ...
                Ingredient("Rapsöl", 4, "EL", "oder Sonnenblumenöl"),
        ...
        self.expected_recipes = [
            ...
            datamodel.Recipe(
                ...
                4,
                [
                    Ingredient("Zucchini", 600, "g", "mittelgroß"),
                    Ingredient("Hackfleisch", 600, "g", "halb und halb"),
                    Ingredient("Kirschtomaten", 200, "g"),
                    Ingredient("Zwiebeln", 100, "g"),
                    Ingredient("Bacon in Scheiben", 100, "g"),
                    Ingredient("Erdnüsse", 100, "g", "gesalzen"),
            ...
            datamodel.Recipe(
                ...
                [
                    ...
                    Ingredient("Chiliflocken", 0.5, "TL", "oder frische Chili"),
                    Ingredient("Knoblauchzehe", 1, ""),
                    Ingredient("Parmesan", 60, "g"),
                    Ingredient("Cashewskerne", 80, "g"),
                    Ingredient("Gutes Olivenöl", 150, "ml", "nach gewünschter Konsistenz"),
                    Ingredient("Meersalz", 0, ""),
                    Ingredient("Gnocchi", 500, "g"),
                    Ingredient("Butter", 2, "EL"),
                    Ingredient("Basilikumblätter", 0, "", "gehackt"),
                ],
                [
            ...
            datamodel.Recipe(
                ...
                4,
                [
                    Ingredient("Lauch", 1, "1 bis 2 Stangen", "500 g bis 650 g"),
                    Ingredient("Knoblauch", 2, "Zehen"),
                    Ingredient("Kartoffeln", 400, "g", "Ungeschält gewogen. Festkochend oder vorwiegend festkochend."),
                    Ingredient("Vegane Butter (*)", 60, "g"),
                    Ingredient("Veganes Hackfleisch (*)", 1, "Packung", "180 g bis 250 g"),
                    Ingredient("Speisestärke", 1, "EL", "10 g"),
                    Ingredient("Vegane Kochsahne oder Cuisine (*)", 250, "g", "250 ml. Z.B. Soja Cuisine oder Hafer Cuisine."),
                    Ingredient("Veganer Frischkäse (*)", 100, "g", "natur oder veganer Kräuterfrischkäse"),
                    Ingredient("Wasser", 800, "g", "800 ml"),
                    Ingredient("Gemüsebrühe Pulver (*)", 1.5, "EL", "22,5 g"),
                    Ingredient("Mittelscharfer Senf", 1, "EL", "Mittelscharf. 15 g"),
                    Ingredient("Hefeflocken ohne Reismehl (*)", 40, "g"),
                    Ingredient("Gemahlener Muskat", 1, "kleine Prise", "gemahlen"),
